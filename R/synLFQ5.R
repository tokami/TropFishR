...
#' synLFQ5 <- lfqRestructure(synLFQ5, MA = 11)
#' plot(synLFQ5, Fname = "rcounts")
#'
#' # ELEFAN_SA (takes approximately 1 minute)
#' \dontrun{
#' output <- ELEFAN_SA(synLFQ5, SA_time = 60*1, seasonalised = FALSE, MA = 11,
#'   init_par = list(Linf = 75, K = 0.5, t_anchor = 0.5),
#'   low_par = list(Linf = 70, K = 0.3, t_anchor = 0),
#'   up_par = list(Linf = 90, K = 0.7, t_anchor = 1)
#' )
#' output$par
#' output$Rn_max
#' plot(output)
