#' @name synCAA2
#'
#' @title Synthetic Catch-at-age data II from Sparre & Venema (1998)
#'
#' @description Synthetic Catch-at-age data II. Can be used for the calculation of Z by means of
#'    \code{\link{CatchCurveCum}}.
#'
#' @docType data
#'
