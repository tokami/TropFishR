...
# #'
# #' @description Function to calculate the catch curve based on length composition data.
# #'
# #' @param midlengths The midlengths of the size intervals.
# #'
# #' @details Nice function to calculate catch curve and Z
# #'
# #' @export
#
# CatchCurve.R <- function(midlengths, catchcomp, L8, K, t0 = NULL,){
#
#   # t of lower length classes
#   lowerLength <- midLength - (interval / 2)
