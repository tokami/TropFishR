...
\begin{figure}
\begin{center}	
\includegraphics[width = 0.4\textwidth]{LFQdat1.png}		       
\caption{Data arrangement 1. A column with dates and a column with length measurements.}
\end{center}
\end{figure}
...
\begin{figure}
\begin{center}	
\includegraphics[width = 0.4\textwidth]{LFQdat2.png}		       
\caption{Data arrangement 2. A column with dates, one with length measurements, and one with the frequency of the length at respective date.}
\end{center}
\end{figure}
...
\begin{figure}
\begin{center}	
\includegraphics[width = 0.7\textwidth]{LFQdat3.png}		       
\caption{Data arrangement 3. A column with the length classes and subsequent columns with the frequency of observed lengths for several sampling times.}
\end{center}
\end{figure}
